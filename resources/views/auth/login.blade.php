...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 mx-auto">
        @csrf
        ...
        <a href="{{ route('register') }}" class="ml-1 text-sm font-semibold text-white underline">
            Register
        </a>
        </p>
        <a
